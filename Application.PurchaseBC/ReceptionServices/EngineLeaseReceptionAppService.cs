...
namespace UniCloud.Application.PurchaseBC.ReceptionServices
{
    ...
    /// </summary>
    [LogAOP]
    public class EngineLeaseReceptionAppService : ContextBoundObject, IEngineLeaseReceptionAppService
    {
        ...
        public void InsertEngineLeaseReception(EngineLeaseReceptionDTO dto)
        {
            ...
            //创建接机项目
            EngineLeaseReception newReception = ReceptionFactory.CreateEngineLeaseReception(dto.StartDate, dto.EndDate,
                dto.SourceId,
                dto.Description);
        ...
        public void ModifyEngineLeaseReception(EngineLeaseReceptionDTO dto)
        {
            ...
            if (updateReception != null)
            {
                ...
                //更新接机行：
                List<EngineLeaseReceptionLineDTO> dtoReceptionLines = dto.ReceptionLines;
        ...
        public void DeleteEngineLeaseReception(EngineLeaseReceptionDTO dto)
        {
            ...
            Reception delEngineLeaseReception = _receptionRepository.Get(dto.EngineLeaseReceptionId);
            //获取需要删除的对象。
