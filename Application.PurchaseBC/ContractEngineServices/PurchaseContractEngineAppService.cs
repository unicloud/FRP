...
namespace UniCloud.Application.PurchaseBC.ContractEngineServices
{
    ...
    public class PurchaseContractEngineAppService : ContextBoundObject, IPurchaseContractEngineAppService
    {
        ...
        {
            PurchaseContractEngine newPurchaseContractEngine = ContractEngineFactory.CreatePurchaseContractEngine("", "");
        ...
        {
            ContractEngine updatePurchaseContractEngine =
                _contractEngineRepository.GetFiltered(t => t.Id == purchaseContractEngine.PurchaseContractEngineId)
                    .FirstOrDefault();
            //获取需要更新的对象。
        ...
        {
            ContractEngine newPurchaseContractEngine =
                _contractEngineRepository.GetFiltered(t => t.Id == purchaseContractEngine.PurchaseContractEngineId)
                    .FirstOrDefault();
            //获取需要删除的对象。
