...
namespace UniCloud.Application.PurchaseBC.ContractAircraftServices
{
    ...
    /// </summary>
    [LogAOP]
    public class LeaseContractAircraftAppService : ContextBoundObject, ILeaseContractAircraftAppService
    {
        ...
        {
            LeaseContractAircraft newLeaseContractAircraft = ContractAircraftFactory.CreateLeaseContractAircraft("", "");
        ...
        {
            ContractAircraft updateLeaseContractAircraft =
                _contractAircraftRepository.GetFiltered(t => t.Id == leaseContractAircraft.LeaseContractAircraftId)
                    .FirstOrDefault();
            //获取需要更新的对象。
        ...
        {
            ContractAircraft newLeaseContractAircraft =
                _contractAircraftRepository.GetFiltered(t => t.Id == leaseContractAircraft.LeaseContractAircraftId)
                    .FirstOrDefault();
            //获取需要删除的对象。
