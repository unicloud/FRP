...
namespace UniCloud.Application.PurchaseBC.MaintainContractServices
{
    ...
    public class MaintainContractAppService : ContextBoundObject, IMaintainContractAppService
    {
        ...
        {
            UndercartMaintainContract newUndercartMaintainContract =
                MaintainContractFactory.CreateUndercartMaintainContract();
            MaintainContractFactory.SetMaintainContract(newUndercartMaintainContract, undercartMaintainContract.Name,
                undercartMaintainContract.Number, undercartMaintainContract.Signatory,
                undercartMaintainContract.SignDate, undercartMaintainContract.Abstract,
                undercartMaintainContract.SignatoryId, undercartMaintainContract.DocumentId,
                undercartMaintainContract.DocumentName);
        ...
        {
            MaintainContract updateUndercartMaintainContract =
                _contractRepository.Get(undercartMaintainContract.UndercartMaintainContractId);
            MaintainContractFactory.SetMaintainContract(updateUndercartMaintainContract, undercartMaintainContract.Name,
                undercartMaintainContract.Number, undercartMaintainContract.Signatory,
                undercartMaintainContract.SignDate, undercartMaintainContract.Abstract,
                undercartMaintainContract.SignatoryId, undercartMaintainContract.DocumentId,
                undercartMaintainContract.DocumentName);
        ...
        {
            MaintainContract deleteUndercartMaintainContract =
                _contractRepository.Get(undercartMaintainContract.UndercartMaintainContractId);
            //获取需要删除的对象。
        ...
        {
            AirframeMaintainContract newAirframeMaintainContract =
                MaintainContractFactory.CreateAirframeMaintainContract();
            MaintainContractFactory.SetMaintainContract(newAirframeMaintainContract, airframeMaintainContract.Name,
                airframeMaintainContract.Number, airframeMaintainContract.Signatory,
                airframeMaintainContract.SignDate, airframeMaintainContract.Abstract,
                airframeMaintainContract.SignatoryId, airframeMaintainContract.DocumentId,
                airframeMaintainContract.DocumentName);
        ...
        {
            MaintainContract updateAirframeMaintainContract =
                _contractRepository.Get(airframeMaintainContract.AirframeMaintainContractId);
            MaintainContractFactory.SetMaintainContract(updateAirframeMaintainContract, airframeMaintainContract.Name,
                airframeMaintainContract.Number, airframeMaintainContract.Signatory,
                airframeMaintainContract.SignDate, airframeMaintainContract.Abstract,
                airframeMaintainContract.SignatoryId, airframeMaintainContract.DocumentId,
                airframeMaintainContract.DocumentName);
        ...
        {
            MaintainContract deleteAirframeMaintainContract =
                _contractRepository.Get(airframeMaintainContract.AirframeMaintainContractId);
            //获取需要删除的对象。
