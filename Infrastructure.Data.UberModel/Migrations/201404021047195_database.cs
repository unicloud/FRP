namespace UniCloud.Infrastructure.Data.UberModel.Migrations
{
    ...
    public partial class database : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("FRP.ProgrammingFile", "IssuedUnitId", "FRP.Manager");
            DropForeignKey("FRP.Dependency", "PnRegId", "FRP.PnReg");
            ...
            DropIndex("FRP.Dependency", new[] { "PnRegId" });
            ...
            DropTable("FRP.SnReg");
            DropTable("FRP.SnInstallHistory");
