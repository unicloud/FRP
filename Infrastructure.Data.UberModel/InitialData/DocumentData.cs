...
namespace UniCloud.Infrastructure.Data.UberModel.InitialData
{
    ...
    public class DocumentData : InitialDataBase
    {
        ...
        public override void InitialData()
        {
          ...
          var document1= DocumentFactory.CreateStandardDocument("计划引进飞机10架飞机.docx", "docx", null, null, "XXX",
                                               true, null);
          var document2 = DocumentFactory.CreateStandardDocument("计划引进飞机11架飞机.docx", "docx", null, null, "XXX",
                                               true, null);
          var document3 = DocumentFactory.CreateStandardDocument("计划引进飞机11架飞机.xlsx", "xlsx", null, null, "XXX",
                                               true, null);

          var document4= DocumentFactory.CreateStandardDocument("计划退出飞机10架飞机.docx", "docx", null, null, "XXX",
                                   true, null);
          var document5 = DocumentFactory.CreateStandardDocument("计划退出飞机11架飞机.docx", "docx", null, null, "XXX",
                                               true, null);
          var document6 = DocumentFactory.CreateStandardDocument("计划退出飞机11架飞机.xlsx", "xlsx", null, null, "XXX",
                                               true, null);
