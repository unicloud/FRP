...
namespace UniCloud.Infrastructure.Data.UberModel.UnitOfWork.Mapping.Sql
{
    ...
    /// </summary>
    internal class AircraftLeaseOrderLineEntityConfiguration : EntityTypeConfiguration<AircraftLeaseOrderLine>
    {
        public AircraftLeaseOrderLineEntityConfiguration()
        {
            ToTable("AircraftLeaseOrderLine", DbConfig.Schema);
            ...
            HasRequired(a => a.LeaseContractAircraft)
                .WithMany(l => l.AircraftLeaseOrderLines)
