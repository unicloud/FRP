...
{
    /// <summary>
    ///      BusinessLicense实体相关配置
    /// </summary>
    internal class BusinessLicenseEntityConfiguration : EntityTypeConfiguration<BusinessLicense>
    {
        public BusinessLicenseEntityConfiguration()
        {
            ToTable("BusinessLicense", DbConfig.Schema);
