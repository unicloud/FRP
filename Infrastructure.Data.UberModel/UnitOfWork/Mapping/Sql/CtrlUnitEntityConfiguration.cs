...
// 文件名：CtrlUnitEntityConfiguration
// 版本：V1.0.0
//
// 修改者： 时间：
// 修改说明：
...
namespace UniCloud.Infrastructure.Data.UberModel.UnitOfWork.Mapping.Sql
{
    ...
    /// CtrlUnit实体相关配置
    /// </summary>
    internal class CtrlUnitEntityConfiguration : EntityTypeConfiguration<CtrlUnit>
    {
        public CtrlUnitEntityConfiguration()
        {
            ToTable("CtrlUnit", DbConfig.Schema);
