...
namespace UniCloud.Infrastructure.Data.UberModel.UnitOfWork.Mapping.Sql
{
    ...
    internal class MaintainCtrlLineEntityConfiguration : EntityTypeConfiguration<MaintainCtrlLine>
    {
        public MaintainCtrlLineEntityConfiguration()
        {
            ...
            Property(p => p.StandardInterval).HasColumnName("StandardInterval").HasMaxLength(100);
            Property(p => p.MaxInterval).HasColumnName("MaxInterval").HasMaxLength(100);
            Property(p => p.MinInterval).HasColumnName("MinInterval").HasMaxLength(100);
