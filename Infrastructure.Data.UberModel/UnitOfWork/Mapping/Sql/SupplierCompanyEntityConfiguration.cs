...
{
    /// <summary>
    ///     SupplierCompany实体相关配置
    /// </summary>
    internal class SupplierCompanyEntityConfiguration : EntityTypeConfiguration<SupplierCompany>
    {
        public SupplierCompanyEntityConfiguration()
        {
            ToTable("SupplierCompany", DbConfig.Schema);
