...
namespace UniCloud.Application.ProjectBC.Query.RelatedDocQueries
{
    public class RelatedDocQuery : IRelatedDocQuery
    {
        ...
        #region IRelatedDocQuery 成员

        public IQueryable<RelatedDocDTO> RelatedDocDTOQuery(QueryBuilder<RelatedDoc> query)
        {
            var result = query.ApplyTo(_unitOfWork.CreateSet<RelatedDoc>())
