...
// 文件名：IAircraftPurchaseReceptionQuery
// 版本：V1.0.0
//
// 修改者： 时间： 
// 修改说明：
...
namespace UniCloud.Application.PurchaseBC.Query.ReceptionQueries
{
    ...
    /// 采购飞机接收项目查询接口
    /// </summary>
    public interface IAircraftPurchaseReceptionQuery
    {
        /// <summary>
        ///    采购飞机接收项目查询
        /// </summary>
        ...
        IQueryable<AircraftPurchaseReceptionDTO> AircraftPurchaseReceptionDTOQuery(
