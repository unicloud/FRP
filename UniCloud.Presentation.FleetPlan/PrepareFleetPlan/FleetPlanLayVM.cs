...
namespace UniCloud.Presentation.FleetPlan.PrepareFleetPlan
{
    ...
    public class FleetPlanLayVM : EditViewModelBase
    {
        ...
        public override void LoadData()
        {
            ...
            AllActionCategories = _service.GetActionCategories(() => RaisePropertyChanged(() => AllActionCategories),
                true);
        ...
        public PlanHistoryDTO SelPlanHistory
        {
            ...
            set
            {
                if (_selPlanHistory != value)
                {
                    ...
                    {
                        if (
                            ViewPlanAircrafts.SourceCollection.Cast<PlanAircraftDTO>()
                                .Any(pa => pa.Id == _selPlanHistory.PlanAircraftId))
                            SelPlanAircraft =
                                ViewPlanAircrafts.SourceCollection.Cast<PlanAircraftDTO>()
                                    .FirstOrDefault(p => p.Id == _selPlanHistory.PlanAircraftId);
            ...
            if (gridView != null)
            {
                ...
                else if (string.Equals(cell.Column.UniqueName, "AircraftType"))
                {
                    ...
                    if (planhistory != null)
                    {
                        ...
                        {
                            var aircraftType =
                                planhistory.AircraftTypes.FirstOrDefault(p => p.Id == planhistory.AircraftTypeId);
        ...
        [Import] public PlanDetailEditDialog editDialog;
            ...
            set
            {
                if (_selActionCategory != value)
                {
                    ...
                    if (value != null)
                    {
                        ...
                        EditPlanHistory.AircraftCategories.AddRange(
                            _service.GetAircraftCategoriesForPlanHistory(EditPlanHistory));
                    }
