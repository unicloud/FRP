...
{
    public class BaseGridViewDoubleClick<THelper>
        where THelper : GridViewDoubleClickHelper
    {
		...
		// 依赖项属性
        public static readonly DependencyProperty HelperProperty = DependencyProperty.RegisterAttached("Helper", typeof(THelper), typeof(BaseGridViewDoubleClick<THelper>), new Telerik.Windows.PropertyMetadata(OnHelperChanged));

        static BaseGridViewDoubleClick()
        {
        }
