...
//【本类功能概述】
// 
// 作者：linxw 时间：2014/4/4 18:08:52
// 文件名：MD5
// 版本：V1.0.0
//
// 修改者：linxw 时间：2014/4/4 18:08:52
// 修改说明：
// ========================================================================*/
#endregion
...
namespace UniCloud.Presentation.Cryptography
{
    /// <summary>
    ...
    public class MD5 : IDisposable
    {
        ...
        {
            if (hashName.Equals("MD5", StringComparison.OrdinalIgnoreCase))
                return new MD5();
