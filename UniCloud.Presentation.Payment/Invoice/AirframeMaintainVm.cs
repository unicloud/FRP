...
namespace UniCloud.Presentation.Payment.Invoice
{
    ...
    public class AirframeMaintainVm: InvoiceVm
    {
        ...
        public AirframeMaintainVm(IRegionManager regionManager)
        {
        ...
        {
            // 创建并注册CollectionView
            AirframeMaintainInvoices = Service.CreateCollection(PaymentDataService.AirframeMaintainInvoices);
            Service.RegisterCollectionView(AirframeMaintainInvoices);
            AirframeMaintainInvoices.PropertyChanged += OnViewPropertyChanged;
        ...
        public SupplierDTO Supplier
        {
            ...
            set
            {
                ...
                {
                    _supplier = value;
                    AirframeMaintainInvoice.SupplierName = _supplier.Name;
        ...
        protected override void OnViewAttach(object sender)
        {
            ...
            DocumentView.ViewModel.InitData(true, AirframeMaintainInvoice.DocumentId, null);
            DocumentView.ShowDialog();
        }
        #endregion
        #endregion
