...
{
    [Export(typeof (CreditMemoManagerVM))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class CreditMemoManagerVM : EditViewModelBase
    {
        #region 声明、初始化
        private readonly IRegionManager _regionManager;

        [ImportingConstructor]
        public CreditMemoManagerVM(IRegionManager regionManager)
        {
