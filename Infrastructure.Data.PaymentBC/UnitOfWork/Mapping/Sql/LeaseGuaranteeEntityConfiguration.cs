...
{
    /// <summary>
    ///     LeaseGuarantee实体相关配置
    /// </summary>
    internal class LeaseGuaranteeEntityConfiguration : EntityTypeConfiguration<LeaseGuarantee>
    {
        public LeaseGuaranteeEntityConfiguration()
        {
            ToTable("LeaseGuarantee", DbConfig.Schema);
