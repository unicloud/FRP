    ...
    public partial class ManageContract
    {
        ...
        private void OnDrop(object sender, DragEventArgs e)
        {
            ...
            if (e.Effects != DragDropEffects.None)
            {
                ...
                if (realDraggedData != null &&
                    (realDestinationItem != null && realDestinationItem.DocumentPathId == realDraggedData.DocumentPathId))
                {
                ...
                var dropDetails =
                    DragDropPayloadManager.GetDataFromObject(e.Data, "DropDetails") as DropIndicationDetails;
                ...
                if (_destinationItems != null)
                {
                    foreach (var trigger in _destinationItems)
                    {
                        ...
                        if (realData != null &&
                            (temp != null && temp.Name.Equals(realData.Name, StringComparison.OrdinalIgnoreCase)))
                        {
                    ...
                    var dropIndex = dropDetails != null && dropDetails.DropIndex >= _destinationItems.Count
                        ? _destinationItems.Count
                        : dropDetails != null && dropDetails.DropIndex < 0 ? 0 : dropDetails.DropIndex;
        ...
        private void FoldersBreadcrumbCurrentItemChanged(object sender, RadRoutedEventArgs e)
        {
