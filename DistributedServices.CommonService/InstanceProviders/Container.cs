...
namespace UniCloud.DistributedServices.CommonService.InstanceProviders
{
    ...
    public static class Container
    {
        ...
        static void ConfigureContainer()
        {
            ...
            //-> Unit of Work与仓储
            //Current.RegisterType(typeof(PurchaseBCUnitOfWork), new PerResolveLifetimeManager());

            //Current.RegisterType<IAircraftRepository, AircraftRepository>();
            //Current.RegisterType<IAircraftTypeRepository, AircraftTypeRepository>();

            //-> 领域服务


            //-> 应用服务
            Current.RegisterType<ICommonServiceAppService, CommonServiceAppService>();
