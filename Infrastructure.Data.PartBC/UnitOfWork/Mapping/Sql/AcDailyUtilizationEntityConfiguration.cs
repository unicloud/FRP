...
namespace UniCloud.Infrastructure.Data.PartBC.UnitOfWork.Mapping.Sql
{
    ...
    internal class AcDailyUtilizationEntityConfiguration : EntityTypeConfiguration<AcDailyUtilization>
    {
        public AcDailyUtilizationEntityConfiguration()
        {
            ...
            Property(p => p.CalculatedValue).HasColumnName("CalculatedValue").HasColumnType("decimal").HasPrecision(16, 4);
            Property(p => p.AmendValue).HasColumnName("AmendValue").HasColumnType("decimal").HasPrecision(16, 4);
