...
namespace UniCloud.Application.PartBC.CtrlUnitServices
{
    ...
    /// </summary>
    [LogAOP]
    public class CtrlUnitAppService : ContextBoundObject, ICtrlUnitAppService
    {
        ...
        {
            CtrlUnit newCtrlUnit = CtrlUnitFactory.CreateCtrlUnit();
        ...
        {
            CtrlUnit updateCtrlUnit = _ctrlUnitRepository.Get(dto.Id); //获取需要更新的对象。
        ...
        {
            CtrlUnit delCtrlUnit = _ctrlUnitRepository.Get(dto.Id); //获取需要删除的对象。
