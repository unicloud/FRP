...
namespace UniCloud.Application.PartBC.MaintainWorkServices
{
    ...
    public class MaintainWorkAppService : ContextBoundObject, IMaintainWorkAppService
    {
        ...
        {
            MaintainWork newMaintainWork = MaintainWorkFactory.CreateMaintainWork();
        ...
        {
            MaintainWork updateMaintainWork = _maintainWorkRepository.Get(dto.Id); //获取需要更新的对象。
        ...
        {
            MaintainWork delMaintainWork = _maintainWorkRepository.Get(dto.Id); //获取需要删除的对象。
